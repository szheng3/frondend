...
/******/([
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        Preferences._writeToStorage = function (prefObj) {
            return new Promise(function (resolve) {
                localStorage.setItem('pdf.preferences', JSON.stringify(prefObj));
                resolve();
            });
        };
        Preferences._readFromStorage = function (prefObj) {
            return new Promise(function (resolve) {
                var readPrefs = JSON.parse(localStorage.getItem('pdf.preferences'));
                resolve(readPrefs);
            });
        };
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        DownloadManager.prototype = {
            downloadUrl: function DownloadManager_downloadUrl(url, filename) {
                ...
                download(url + '#pdf.action=download', filename);
            },
            ...
            ViewHistory.prototype = {
                _writeToStorage: function ViewHistory_writeToStorage() {
                    return new Promise(function (resolve) {
                        ...
                        localStorage.setItem('pdf.history', databaseStr);
                        resolve();
                    }.bind(this));
                },
                _readFromStorage: function ViewHistory_readFromStorage() {
                    return new Promise(function (resolve) {
                        var value = localStorage.getItem('pdf.history');
                        if (!value) {
