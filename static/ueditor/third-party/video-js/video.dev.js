...
vjs.Player.prototype.exitFullWindow = function(){
  ...
  vjs.removeClass(document.body, 'vjs-full-window');
    ...
    // Resize the box, admincontroller, and poster to original sizes
  // this.positionAll();
...
// admincontroller: function(){ return this.techCall('admincontroller'); },
 ...
 * @type {String}
 */
vjs.media.ApiMethods = 'play,pause,paused,currentTime,setCurrentTime,duration,buffered,volume,setVolume,muted,setMuted,width,height,supportsFullScreen,enterFullScreen,src,load,currentSrc,preload,setPreload,autoplay,setAutoplay,loop,setLoop,error,networkState,readyState,seeking,initialTime,startOffsetTime,played,seekable,ended,videoTracks,audioTracks,videoWidth,videoHeight,textTracks,defaultPlaybackRate,playbackRate,mediaGroup,admincontroller,controls,defaultMuted'.split(',');
...
vjs.Flash = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    // Even though the iframe was inserted into a page on the web, Firefox + Flash considers it a local app trying to access an internet file.
      // I tried mulitple ways of setting the iframe src attribute but couldn't find a src that worked well. Tried a real/fake source, in/out of modal.
    ...
    if (options['iFrameMode'] === true && !vjs.IS_FIREFOX) {
      ...
      vjs.on(iFrm, 'load', vjs.bind(this, function(){
        ...
        // Using document.write actually got around the security error that browsers were throwing.
          // Again, it's a dynamically generated (same modal) iframe, loading an external Flash swf.
...
var api = vjs.Flash.prototype,
    readWrite = 'rtmpConnection,rtmpStream,preload,currentTime,defaultPlaybackRate,playbackRate,autoplay,loop,mediaGroup,admincontroller,controls,volume,muted,defaultMuted'.split(','),
