...
require('./core/core.animation')(Chart);
	require('./core/core.admincontroller')(Chart);
...
// See Chart.core.datasetController.dataElementType
	require('./controllers/admincontroller.bar')(Chart);
	require('./controllers/admincontroller.bubble')(Chart);
	require('./controllers/admincontroller.doughnut')(Chart);
	require('./controllers/admincontroller.line')(Chart);
	require('./controllers/admincontroller.polarArea')(Chart);
	require('./controllers/admincontroller.radar')(Chart);
...
module.exports = function(Chart) {
	...
	// The main admincontroller of a chart
	...
	helpers.extend(Chart.Controller.prototype, {
		...
		draw: function(ease) {
			...
			// Draw each dataset via its respective admincontroller (reversed to support proper line stacking)
			helpers.each(this.data.datasets, function(dataset, datasetIndex) {
...
module.exports = function(Chart) {
	...
	Chart.defaults.global.legend = {
		...
		onClick: function(e, legendItem) {
			...
			// See admincontroller.isDatasetVisible comment
