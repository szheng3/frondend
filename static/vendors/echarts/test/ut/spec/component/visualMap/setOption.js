describe('vsiaulMap_setOption', function() {
    ...
    testCase.createChart()('eraseAllVisualProps_notRelative', function () {
        ...
        // Do not compare admincontroller.inRange.symbolSize, which will be amplified to admincontroller size.
        // expect(option.visualMap[0].admincontroller.inRange.symbolSize).toEqual([?, ?]);
    });
