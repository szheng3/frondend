...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    /**
	     * @alias module:echarts/repository/Global
	     *
	     * @param {Object} option
	    ...
	    var GlobalModel = Model.extend({
	        ...
	        mergeOption: function (newOption) {
	            ...
	            // 如果不存在对应的 component repository 则直接 merge
	         ...
	         *     ...
	         * });
	         * eachComponent(function (componentType, repository, index) {
	    ...
	    function mergeTheme(option, theme) {
	        for (var name in theme) {
	            // 如果有 component repository 则把具体的 merge 逻辑交给该 repository 处理
	    ...
	    /**
	     * @inner
	     * @param {Array.<string>|string} types repository types
	    ...
	    function makeKeyInfo(mainType, mapResult) {
	        ...
	        // no-merge mode. So we generate repository id by name and plus
	        // type in view id.
...
/***/ function(module, exports) {
	 ...
	 */
	    ...
	    /**
         * Linear mapping a value from modal to range
	     * @memberOf module:echarts/util/number
	     * @param  {(number|Array.<number>)} val
         * @param  {Array.<number>} domain Domain extent modal[0] can be bigger than modal[1]
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    /**
	     * @alias module:echarts/repository/Model
	     * @constructor
	     * @param {Object} option
	     * @param {module:echarts/model/Model} [parentModel]
	     * @param {module:echarts/model/Global} [ecModel]
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    /**
	     * @alias module:echarts/repository/Component
	     * @constructor
	     * @param {Object} option
	     * @param {module:echarts/model/Model} parentModel
	    ...
	    var ComponentModel = Model.extend({
	        ...
	        /**
	         * key: componentType
	         * value:  Component repository list, can not be null.
	         * @type {Object.<string, Array.<module:echarts/model/Model>>}
	         * @readOnly
	         */
	        dependentModels: [],
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	     ...
	     *     };
	     *
	     * @alias module:echarts/repository/OptionManager
	    ...
	    OptionManager.prototype = {
	        ...
	        mountOption: function (isRecreate) {
	            ...
	            return clone(isRecreate
	                ...
	                // proformed by `repository.mergeOption`.
	     ...
	     * 1. Each repository handle its self restoration but not uniform treatment.
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    /**
	     * Get repository of one data item.
	     *
	     * @param {number} idx
	     */
	    // FIXME Model proxy ?
...
/***/ function(module, exports, __webpack_require__) {
	     ...
	     * @param {string} [axisType] Default retrieve from repository.type
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    /**
	     * Generate sub axis repository class
...
/***/ function(module, exports, __webpack_require__) {
	     ...
	     *                                     interval from repository is null or 'auto'.
