define(function(require) {
    ...
    var PiecewiseModel = VisualMapModel.extend({
        ...
        defaultOption: {
            ...
            itemWidth: 20,              // When put the admincontroller vertically, it is the length of
                                        // horizontal side of each item. Otherwise, vertical side.
            itemHeight: 14,             // When put the admincontroller vertically, it is the length of
        ...
        findTargetDataIndices: function (pieceIndex) {
            ...
            this.eachTargetSeries(function (seriesModel) {
                ...
                data.each(this.getDataDimension(data), function (value, dataIndex) {
                    // Should always base on repository pieceList, because it is order sensitive.
