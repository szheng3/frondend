define(function (require) {
    ...
    return ComponentView.extend({
         ...
         * @return {Object} {
         *                   cartesians: [
         *                       {repository: coord0, axisModels: [axis1, axis3], coordIndex: 1},
         *                       {repository: coord1, axisModels: [axis0, axis2], coordIndex: 0},
         *                       ...
         *                   ],  // cartesians must not be null/undefined.
         *                   polars: [
         *                       {repository: coord0, axisModels: [axis4], coordIndex: 0},
         *                       ...
