...
define(function(require) {
    ...
    // Only create one roam admincontroller for each coordinate system.
    // one roam admincontroller might be refered by two inside data zoom
    ...
    /**
     * Key: coordId, value: {dataZoomInfos: [], count, admincontroller}
     * @type {Array.<Object>}
     */
